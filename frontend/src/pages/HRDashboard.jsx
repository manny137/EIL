...
export default function HrDashboard() {
	...
	const thStyle = "p-3 border bg-gray-100 font-semibold text-left";
	...
	return (
		<div className="min-h-screen bg-gray-50 p-6">
			<div className="max-w-7xl mx-auto bg-white p-8 rounded-xl shadow-md space-y-16 border">
				...
				{/* Pending Approvals */}
				<section>
					<h2 className="text-2xl font-semibold mb-4 text-gray-700">Pending Employee Approvals</h2>
					{pending.length === 0 ? (
									...
									{pending.map(emp => (
										<tr key={emp.id}>
											...
											<td className={tdStyle}>
												<button onClick={() => handleOpenPdf(emp.id, 'aadhaar')} className="text-blue-600 underline hover:text-blue-800">View</button>
											</td>
											<td className={tdStyle}>
												<button onClick={() => handleOpenPdf(emp.id, 'pan')} className="text-blue-600 underline hover:text-blue-800">View</button>
											</td>
											<td className={tdStyle}>
				...
				{/* Bank Details */}
				<section>
					<h2 className="text-2xl font-semibold mb-4 text-gray-700">Employee Bank Details</h2>
				...
				{/* Leave Applications */}
				<section>
					<h2 className="text-2xl font-semibold mb-4 text-gray-700">Employee Leave Applications</h2>
					{leaveApps.length === 0 ? (
