        ...
        <div className="w-[400px] mx-auto bg-white rounded-lg border border-gray-200 p-0 mt-4 shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="px-8 pt-6 pb-0 space-y-6">
            <div className="flex flex-col gap-6">
              <div>
                <label htmlFor="employee-username" className="block mb-1 font-semibold text-gray-800">Username*</label>
                <div className="relative">
                  <span className="absolute inset-y-0 left-3 flex items-center text-gray-400">
                    <FaUser />
                  </span>
                  <input id="employee-username" type="text" className="w-full border border-gray-300 pl-10 py-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-400 text-black transition-colors duration-200 hover:border-blue-400" placeholder="Username" />
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  ...
                  <input id="employee-password" type="password" className="w-full border border-gray-300 pl-10 py-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-400 text-black transition-colors duration-200 hover:border-blue-400 pl-10" placeholder="Password" />
                </div>
              </div>
            </div>
          ...
          <div className="w-full text-center mt-2 pb-4">
            ...
            <Link to="/register/employee" className="text-[#007bff] hover:underline hover:text-[#0056b3] font-semibold transition-colors duration-200">Register here</Link>
          </div>
        </div>
      </div>
      <div />
